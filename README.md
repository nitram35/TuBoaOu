...
##### Step 3.1: Add Firebase API Key for Authentification with Google
 ...
 - `VITE_FIREBASE_API_KEY  =  "AIzaSyDwlLQY4wt4IzdPG1Fu1Jen0REsEv4F48Y"` 
...
Jordan : `MONGODB_URI = 'mongodb+srv://jordanblm:jordanblm@tuboaou.krsxbcv.mongodb.net/tuboaou?retryWrites=true&w=majority&appName=TuBoaOu'`
